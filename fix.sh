...
# This is a legacy fix code from https://gist.github.com/rraks/4edddb99b50b94fe6298adbf3c9f43eb, NOT MY WORK.
# I am just testing if it works and also made few changes (it fails after package update)
...
for value in "${i2c_addr[@]}"; do
    ...
    # The possible fix for volume low issue: 0x0a is digital volume control: 0x00 = 0dB (full), 0x1e = -15dB, 0x2e = -23dB
    # Can check my reference in README to double check
    i2cset -f -y "$i2c_bus" "$value" 0x0a 0x00
